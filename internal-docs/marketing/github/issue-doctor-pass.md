## Share your DevReady moment

If **`devready`** shows **Ready to work**, post proof here. It helps the next person trust the install.

### What to post

1. **Screenshot** of `devready` or `devshell doctor` output (terminal)
